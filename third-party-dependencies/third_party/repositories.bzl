...
def fetch_deps():
    ...
    http_archive(
        name = "catch2",
        url = "https://github.com/catchorg/Catch2/archive/refs/tags/v3.14.0.zip",
        sha256 = "33c9dfd4de6979fe127d5c43eb883818994f723938ce5aec0945410c8d6ebea2",
        strip_prefix = "Catch2-3.14.0",
    )
